...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/_internal/utils.mjs
// @__NO_SIDE_EFFECTS__
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/perf_hooks/performance.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/node/console.mjs
import { Writable } from "node:stream";

// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/mock/noop.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
globalThis.console = console_default;

// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/hrtime.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/process.mjs
import { EventEmitter } from "node:events";

// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/tty/write-stream.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/tty/read-stream.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// C:/Users/dlckd/AppData/Roaming/npm/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
var aiPluginJson = {
  schema_version: "v1",
  name_for_human: "Anomi - R2 \uCF54\uB529 \uBE44\uC11C",
  // GPT 이름 반영
  name_for_model: "Anomi_R2_Coding_Assistant",
  // 모델이 사용할 이름
  description_for_human: "Anomi\uB2D8\uC744 \uC704\uD55C \uCF54\uB529 \uBCF4\uC870 \uBC0F Cloudflare R2 \uD30C\uC77C \uAD00\uB9AC GPT\uC785\uB2C8\uB2E4.",
...
app.post(
  ...
  async (c) => {
    ...
    try {
      const list = await env2.FILES.list({
...
app.post("/v1/create_file", zValidator("json", createFileSchema), async (c) => {
  ...
  try {
    await env2.FILES.put(path, content);
...
app.post("/v1/read_file", zValidator("json", readFileSchema), async (c) => {
  ...
  const env2 = c.env;
  try {
    const obj = await env2.FILES.get(path);
    if (!obj) {
...
app.post(
  ...
  async (c) => {
    ...
    const env2 = c.env;
    try {
      const list = await env2.FILES.list({ prefix: path });
      const deletePromises = list.objects.map(
        (obj) => env2.FILES.delete(obj.key)
      );
...
app.get("*", async (c) => {
  ...
  try {
    const object = await env2.FILES.get(key);
    if (object === null) {
